...
class Decoder(nn.Module):
    ...
    def forward(self, dec_input, enc_output, dec_mask, enc_dec_mask): # memory = seq of output of the last layer of encoder!
        ...
        for layer in self.layers:
            dec_output, self_attn, enc_dec_attn = layer(dec_output, enc_output, dec_mask, enc_dec_mask)
